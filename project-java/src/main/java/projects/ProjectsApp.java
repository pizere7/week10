...
public class ProjectsApp {
	...
	private void selectProject() {
		...
		curProject = projectService.fetAllProjectById(ProjectId);
	...
	private void listProjects() {
		List<Project> projects = projectService.fetAllProjects();
		System.out.println("\nProjects:");
	...
	private void createProject() {
		...
		System.out.println("Your have successfully created project: "+ dbProject);
